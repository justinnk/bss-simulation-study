...
public class BSSFormulas extends jSSTLScript{
	...
	public BSSFormulas() {
		...
		this.addFormula("eventuallyEmpty", new EventuallyFormula(new ParametricInterval(0, T_END_),
		...
		this.addFormula("phi_time",
			 ...
			 */
			this.addFormula("phi_empty", new EventuallyFormula(new ParametricInterval(0, T_END_),
					new NotFormula(new ReferencedFormula(this, "phiB"))), null);
			/*
			 * PHI_FULL
			 * The station will eventually be full
			 */
			this.addFormula("phi_full", new EventuallyFormula(new ParametricInterval(0, T_END_),
